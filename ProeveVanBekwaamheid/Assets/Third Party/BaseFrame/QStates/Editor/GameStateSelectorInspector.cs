...
namespace BaseFrame.QStates.Editors {
    ...
    public class GameStateSelectorInspector : Editor {
        ...
        public override void OnInspectorGUI () {
            ...
            myScript.startState = (BaseGameState)EditorGUILayout.ObjectField(myScript.startState, typeof(QState), true);
        ...
        private GameObject DrawItem (GameObject _data) {
            ...
            if (_data != null) {
                ...
                string newstring = _data.GetComponent<QState>().GetType().ToString().Remove(0, 10);
